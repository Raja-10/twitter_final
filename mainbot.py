...
while True:
    user = api.get_user('RAJAYOGESHWAR|1️⃣ Followers')
    api.update_profile(name=f'raja|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : raja|{follower_count(user)} Followers')
